...
Võrdle tulemusi ja analüüsi: kumb rühm oli keskmiselt tugevam?"),
  ...
  \\begin{itemize}
    ...
    \\item[\\Square] $\\frac{1}{6}$.
  \\end{itemize}"),
  list(goal = 25, level = 1, task = "Joonisel \\@ref(fig:tasks-lines-angles) on näidatud kahe sirge lõikamisel kolmanda sirgega tekkinud nurgad. Uuri joonist ja täida lüngad:\\leavevmode\\
    Nurgad \\qty{113}{\\degree} ja $\\alpha$ on \\blank{lähisnurgad}.\\leavevmode\\
    Nurk $\\alpha=\\blank{84}\\unit{\\degree}$.\\leavevmode\\
    Nurgad \\qty{113}{\\degree} ja $\\beta$ on \\blank{põiknurgad}.\\leavevmode\\
    Nurk $\\alpha=\\blank{96}\\unit{\\degree}$.
  "),
  ...
  list(goal = 45, level = 3, task = "Joonisel \\@ref(fig:tasks-triangle-gravitational-center) on kolmnurk $KLM$. Selle kolmnurga raskuskeset märgib joonisel punkt $O$. Joonesta kolmnurgale mediaanid tippudest $M$ ja $L$!\\leavevmode\\
       ...
       Küljele $KM$ tõmmatud mediaani pikkus on \\blank{27}\\unit{\\centi\\m}."
  ),
  list(
    goal = 45,
    level = 3,
    ...
    Trapetsi pikem alus on \\blank{7} pikkusühikut.\\leavevmode\\
    Trapetsi pindala on \\blank{21} pindalaühikut.\\leavevmode\\
    Kujundi $ABCD$ pindala on \\blank{31,5} pindalaühikut."
  ),
  list(
    goal = 45,
    level = 3,
  ...
  list(goal = 48, level = 1, task = "Joonisel \\@ref(fig:tasks-triangle-central-line) on kolmnurk $ABC$, millesse on joonestatud lõik $a$. Uuri joonist ning vali õiged väited valikvastuste seast lõigu $a$ kohta ja täida lünk:\\leavevmode\\
    ...
    \\end{itemize}
    Lõigu $a$ pikkus on \\blank{3} pikkusühikut.
    "),
  list(goal = 48, level = 1, task = "Kolmnurga külgede pikkused on \\qty{4}{\\centi\\m}, \\qty{6}{\\centi\\m} ja \\qty{7}{\\centi\\m}. Arvuta kolmnurga kesklõikudest moodustatud kolmnurga ümbermõõt!\\leavevmode\\
       Kesklõikudest moodustunud komnurga ümbermõõt on $P=\\blank{\\num{8,5}}\\unit{\\centi\\m}$."),
  list(
    goal = 48,
    level = 1,
    ...
    Arvuta kesklõigu pikkus! Kirjuta lünkadesse vastavad arvud!\\leavevmode\\
    $K=\\frac{\\blank{\\qty{5,1}{\\centi\\m}} + \\blank{\\qty{8,9}{\\centi\\m}}}{2}=\\blank{7}\\unit{\\centi\\m}$."
  ),
  list(
    goal = 48,
    level = 1,
    ...
    Täida lüngad järgnevates lausetes:\\leavevmode\\
    Kuivenduskraavi pikkus on $k=300+\\blank{500}=\\blank{800}\\,(\\unit{\\m})$.\\leavevmode\\
    Maatüki lühema aluse pikkus on \\blank{600}\\unit{\\m}.\\leavevmode\\
    Maatüki pindala on \\blank{36}\\unit{\\hectare}."
  ),
  list(
    goal = 50,
    level = 4,

...
description: "This is the documentation for the courses of math, physics and chemistry at the third level."
lang: et
include-before:
    - \input{title-page.tex}
title: "`r if (knitr::is_latex_output()) { '' } else { 'Fundamentaalsed<br/>loodusteadused<br/>matemaatiliselt' }`"
...
if (knitr::is_latex_output()) {
  "\\href{https://fundamentaalsed-loodusteadused-matemaatiliselt.ons.ee}{Veebiteisend.}"
}
